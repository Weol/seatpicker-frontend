...
If you prefer, you
can [use styled-components instead](https://mui.com/material-ui/guides/interoperability/#styled-components).
...
You can head back to the documentation, continuing browsing it from
